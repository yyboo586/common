...
// DefaultResponse is the default implementation of HandlerResponse.
...
// HandleResponse is the default middleware handling handler response object and its error.
